...
public abstract class BaseFileServiceUIGuard<CALLBACK extends Binder, INTERFACE extends IInterface> implements ServiceConnection {
    ...
    private final HashMap<String, Object> uiCacheMap = new HashMap<String, Object>();
    ...
    protected BaseFileServiceUIGuard(Class<?> serviceClass) {
    	Log.e("", "---------------- BaseFileServiceUIGuard = " + serviceClass.getSimpleName());
    ...
    public void onServiceConnected(ComponentName name, IBinder service) {
        ...
        FileDownloadEventPool.getImpl().asyncPublishInNewThread(
        		new DownloadServiceConnectChangedEvent(
    ...
    public void onServiceDisconnected(ComponentName name) {
        if (this.service != null) {
            try {
            	...
            	FileDownloadLog.d(this, "----------discontect = %s %s", name, this.service);
                e.printStackTrace();
            }
        }
    ...
    public void bindStartByContext(final Context context) {
        ...
        Log.e("", "------------ already = " + BIND_CONTEXTS.contains(context));
...
//        boolean ret = context.bindService(new Intent(context, FileDownloadService.class), this, Context.BIND_AUTO_CREATE);
