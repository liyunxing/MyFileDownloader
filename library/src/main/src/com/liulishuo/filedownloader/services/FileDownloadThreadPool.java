...
class FileDownloadThreadPool {
    ...
    private SparseArray<FileDownloadRunnable> runnablePool = new SparseArray<FileDownloadRunnable>();
    ...
    private synchronized void checkNoExist() {
        ...
        SparseArray<FileDownloadRunnable> correctedRunnablePool = new SparseArray<FileDownloadRunnable>();
