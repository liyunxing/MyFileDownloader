 ...
 */
public abstract class BaseFileService<CALLBACK extends IInterface, Binder> extends Service {

    private final RemoteCallbackList<CALLBACK> callbackList = new RemoteCallbackList<CALLBACK>();
