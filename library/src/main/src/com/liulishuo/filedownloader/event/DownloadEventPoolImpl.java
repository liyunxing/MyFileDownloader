...
public class DownloadEventPoolImpl implements IDownloadEventPool {
    ...
    private final HashMap<String, LinkedList<IDownloadListener>> listenersMap = new HashMap<String, LinkedList<IDownloadListener>>();
    ...
    public boolean addListener(final String eventId, final IDownloadListener listener) {
        ...
        if (container == null) {
            listenersMap.put(eventId, container = new LinkedList<IDownloadListener>());
        }
