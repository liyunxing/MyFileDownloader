 ...
 */
public class MultitaskTestActivity extends Activity {
    ...
    private FileDownloadListener createLis() {
        return new FileDownloadListener() {
            ...
            protected void pending(BaseDownloadTask task, int soFarBytes, int totalBytes) {
                ...
                pendingInfoTv.append((Integer) task.getTag() + " | ");
            }
            ...
            protected void connected(BaseDownloadTask task, String etag, boolean isContinue, int soFarBytes, int totalBytes) {
                ...
                connectedInfoTv.append((Integer) task.getTag() + " | ");
            }
...
//                progressInfoTv.append((int)task.getTag() + " | ");
            ...
            protected void retry(BaseDownloadTask task, Throwable ex, int retryingTimes, int soFarBytes) {
                ...
                retryInfoTv.append((Integer)task.getTag() + " | ");
            }
            ...
            protected void paused(BaseDownloadTask task, int soFarBytes, int totalBytes) {
                ...
                pausedInfoTv.append((Integer) task.getTag() + " | ");
                overTaskPb.setProgress(overTaskPb.getProgress() + 1);
            }
            ...
            protected void error(BaseDownloadTask task, Throwable e) {
                ...
                errorInfoTv.append((Integer) task.getTag() + " | ");
                overTaskPb.setProgress(overTaskPb.getProgress() + 1);
                checkEndAll();
            }
            ...
            protected void warn(BaseDownloadTask task) {
                ...
                warnInfoTv.append((Integer) task.getTag() + " | ");
                overTaskPb.setProgress(overTaskPb.getProgress() + 1);
                checkEndAll();
            }
        };
    ...
    private void goTimeCount() {
        final int time = (Integer) timeConsumeTv.getTag();
